...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-sm bg-neutral-900 transform transition-transform duration-300 ease-out">
        <div className=" p-2 border-neutral-800 rounded">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Scale className="h-6 w-6 text-gold-500" />
              <span className="text-base md:text-lg font-semibold text-white">Omena & Advogados</span>
            </div>
            <button 
              onClick={onClose}
