...
export default function ChatBot() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      {isOpen ? (
        <div className="bg-white rounded-lg shadow-xl w-[90vw] max-w-[350px] h-[500px] flex flex-col">
          <div className="bg-gold-500 text-white p-4 rounded-t-lg flex justify-between items-center">
            <h3 className="font-serif text-black dark:text-white text-sm md:text-base">Chat Omena & Advogados</h3>
            <button
