      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg sm:text-xl lg:text-2xl font-serif text-black dark:text-white">Omena & Advogados</span>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <nav className="flex space-x-8">
              ...
              <a href="#instagram" className="text-neutral-900 hover:text-gold-500 dark:text-gold-500 dark:hover:text-white transition-colors">Instagram</a>
